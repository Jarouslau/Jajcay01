...
<body>
    <div class="container">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            echo "<h2>ID objednávok a súvisiace mená zamestnancov pre objednávky, ktoré boli odoslané po $date</h2>";
            while ($row = $result->fetch_assoc()) {
                echo "OrderID: " . $row['OrderID'] . " - Employee: " . $row['FirstName'] . " " . $row['LastName'] . "<br>";
            }
        } else {
